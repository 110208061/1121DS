...
public class BasketballReservationPage extends JFrame implements NextBack{
	...
	public BasketballReservationPage(User user) {
		this.user = user;
			...
			class ButtonListener implements ActionListener{
				public void actionPerformed(ActionEvent e) {
					...
					if(count < 2) {
						...
						if(num%5 == 0) {
							if(num<5) {
								dates[StringCount] = 10;
								StringCount++;
							}else {
								dates[StringCount] = 15;
								StringCount++;
							}
							...
							if(num<5) {
								dates[StringCount] = 11;
								StringCount++;
							}else {
								dates[StringCount] = 16;
								StringCount++;
							}
							
						}else if(num%5 == 2) {
							if(num<5) {
								dates[StringCount] = 12;
								StringCount++;
							}else {
								dates[StringCount] = 17;
								StringCount++;
							}
							
						}else if(num%5 == 3) {
							if(num<5) {
								dates[StringCount] = 13;
								StringCount++;
							}else {
								dates[StringCount] = 18;
								StringCount++;
							}
							
						}else {
							if(num<5) {
								dates[StringCount] = 14;
								StringCount++;
							}else {
								dates[StringCount] = 19;
								StringCount++;
							}
